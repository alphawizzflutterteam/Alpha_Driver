...
class RescheduleOrderPopup extends StatefulWidget {
  final String order_id;
  final String reason;

  const RescheduleOrderPopup(
      {super.key, required this.order_id, required this.reason});

  @override
  _RescheduleOrderPopupState createState() => _RescheduleOrderPopupState();
}

class _RescheduleOrderPopupState extends State<RescheduleOrderPopup> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Stack(
            children: [
              ...
              Padding(
                ...
                child: Image.asset(
                  "assets/images/rescheduling.png",
                  width: 60,
                  height: 60,
                ),
              ),
          ...
          const Text(
            'Are you sure, that you want to reschedule Order?',
                  ...
                  onPressed: () async {
                    ...
                    Map data = {
                      ...
                      "expected_delivery_date":
                          orderDetailController.shipmentDate.value,
                      "cause": widget.reason
                    };
